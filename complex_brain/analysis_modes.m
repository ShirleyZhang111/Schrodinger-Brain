...
mode_path = 'your_save_path_of_complex_linear_group_model'; % save_path from calc_coefficients_linear_group.m
load([mode_path 'Group_rfMRI_resting_Q_G_lambda_complex.mat']);
