data_path = './Results/your_save_path_of_nonlinear_model'; %  save_path in calc_coefficients_nonlinear.m
items = dir(data_path);
items = items(3:end);
% Group parameters
...
data_path_sc = './Results/your_save_path_of_SC_nonlinear_model'; %  save_path in calc_coefficients_SC_nonlinear.m
